...
class AttasLatPR(GaussianTransition, GaussianMeasurement, sde.Euler):
    """ATTAS lateral-directional motion model with 2 outputs."""
    ...
    def setup(self):
        ...
        self.L0 = self.param("L0", nn.initializers.zeros, ())
        ...
        self.N0 = self.param("N0", nn.initializers.zeros, ())
